...
import { CreditCard, CheckCircle2, Clock, Zap, ShieldCheck, ArrowRight, Activity, Lock } from "lucide-react"
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 space-y-6 mesh-gradient rounded-[48px] border border-border/20">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs max-w-xs mx-auto font-bold uppercase tracking-widest opacity-60">Billing management is only accessible by facility owners.</p>
        </div>
